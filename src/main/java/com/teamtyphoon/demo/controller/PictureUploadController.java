...
import com.teamtyphoon.demo.config.PictureUploadProperties;
...
public class PictureUploadController {
	...
	public void getUploadedPicture(HttpServletResponse response) throws IOException {
		Resource picturePath = userProfileSession.getPicturePath() == null ? anonymousPicture
				: userProfileSession.getPicturePath();
